...
B(d){var x=this.d
x===$&&A.a()
return A.ev(new B.b5j(),new A.bo(x,A.t(x).i("bo<1>")),y.k)}}
B.WW.prototype={
P(){return new B.ajT(A.ah())}}
B.ajT.prototype={
B(d){var x=null,w=this.a,v=w.c
w=w.d
return A.a3(x,A.kl(x,x,C.bN,A.a1(A.b([A.v("verde - terminado",x,x,x,x,x,x,x,x,x),A.v("Narjanja - hay que cobrar",x,x,x,x,x,x,x,x,x),A.v("Amarrillo - estamos trabajando",x,x,x,x,x,x,x,x,x),A.v("Rojo, hay problemas",x,x,x,x,x,x,x,x,x),A.f9(new B.b5e(this),y.b)],y.u),C.f,x,C.i,C.h,C.l),x,C.cn),C.k,x,x,x,x,w,x,x,x,x,x,v)},
...
h.push(A.a1(A.b([o,n,new A.am(null,30,null,null),m,l,A.a1(i,C.f,null,C.i,C.h,C.l)],p),C.f,null,C.i,C.h,C.l))}else h.push(A.a1(A.b([A.v("Debe registrar avances en esta tesis para poder verla aca",null,null,null,null,null,null,null,null,null),u.aKw(a0)],p),C.f,null,C.i,C.h,C.l))
...
aKw(d){return A.a1(A.b([A.bZ(this.d.a,!1,new B.b57(this,d),!0,15,C.I,"Todo bien",-1)],y.u),C.f,null,C.i,C.h,C.l)},
c1q(d,e,f){if(f===1)return $.jp()
else if(d===100)return $.p8()
else if(e>=d-5&&e<=d+5)return $.cIg()
else if(e<d)return $.cYg()
else return $.jp()}}
var z=a.updateTypes([])
B.b5j.prototype={
$2(d,e){var x,w=null
...
u=x.length
w=this.a
return A.a1(A.b([A.v("Tenemos "+u+" proyectos en curso",v,v,v,v,v,v,v,v,v),new A.am(v,w.a.d*0.8,A.fE(v,new B.b5d(w,x),u,v,v,v,v,v,v,!1,!1),v)],y.u),C.f,v,C.i,C.h,C.l)},
$C:"$3",
$R:3,
$S:293}
B.b5a.prototype={
$1(d){return(d.d==="TESIS"||C.b.ej(d.dx,new B.b59()))&&d.e.bC(A.U(2024,1,1,0,0,0,0,0))},
$S:53}
B.b59.prototype={
...
x(A.N,[B.B9,B.WW])
x(A.Q,[B.ajU,B.ajT])
x(A.o6,[B.b5j,B.b5h,B.b5i,B.b5c,B.b5d,B.b58])
...
x($,"dpp","cYg",()=>A.Lb(D.aFm))})()};
((a,b)=>{a[b]=a.current
a.eventLog.push({p:"main.dart.js_2",e:"endPart",h:b})})($__dart_deferred_initializers__,"AW+uqknW+2VkEtbxdwIW4pKC85s=");